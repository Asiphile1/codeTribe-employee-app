...
const App = () => {
  ...
  useEffect(() => {
    ...
    const storedPastEmployees =
      JSON.parse(localStorage.getItem("pastEmployees")) || [];
  ...
  const handleLogin = (username, password) => {
    ...
    if (username === validUsername && password === validPassword) {
      ...
      alert(
        "Please enter a valid username or password, check your spelling and try again. Enjoy your day!"
      );
    }
  };
